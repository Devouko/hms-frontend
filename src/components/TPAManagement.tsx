                ...
                >
                  <div className="flex items-center justify-between mb-3">
                    ...
                    <span className={`px-2 py-1 rounded text-xs ${
                      tpa.status === 'Active' ? 'bg-green-100 text-green-700' : 'bg-red-100 text-red-700'
                    }`}>
                      {tpa.status}
                    </span>
                  </div>
                  ...
                  <div className="space-y-2 text-sm">
                    ...
                    <div className="flex justify-between">
                      <div>
                        ...
                        <p className="text-green-600">${tpa.cashlessLimit?.toLocaleString()}</p>
                      </div>
                      <div>
                        <p className="font-medium">Reimbursement</p>
                        <p className="text-blue-600">${tpa.reimbursementLimit?.toLocaleString()}</p>
                      </div>
                    </div>
